...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<img class="logo" href="index.html" src="images/myshkabezfona (1).png"></img>
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				<li class="menu_mm"><a href="index.php">Меню</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="register_form_container">
						<div class="register_form_title">Зарегистрироваться сейчас</div>
						<form action="register.php" id="register_form" class="register_form" method="post" onsubmit="return validateForm()">
							<div class="row register_row">
								<div class="col-lg-6 register_col">
									<input type="text" class="form_input" placeholder="Логин" name="username" required="required" id="username">
								</div>
								<div class="col-lg-6 register_col">
									<input type="email" class="form_input" placeholder="Email" name="email" required="required" id="email">
								</div>
								<div class="col-lg-6 register_col">
									<input type="password" class="form_input" placeholder="Пароль" name="password" id="password">
								</div>
								<div class="col-lg-6 register_col">
									<input type="password" class="form_input" placeholder="Повторный пароль" name="confirm_password" id="confirm_password">
								</div>
								<div class="col">
									<button type="submit" class="form_button trans_200">Зарегистрироваться</button>
								</div>
							</div>
						</form>
						<a class="register_form_title" href="loggin.php">Войти</a>
					</div>
				</div>
