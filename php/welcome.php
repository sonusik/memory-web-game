						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<div class="header_content_right ml-auto text-right">
                                ...
                                if (isset($_SESSION['username'])) {
                                    $username = $_SESSION['username']; // Если авторизован, сохраняем имя пользователя
                                    $isLoggedIn = true; // Флаг для авторизации
                                } else {
                                    $isLoggedIn = false; // Если не авторизован, флаг отключен
                                }
                                ?>
                                ...
                                <div class="user">
                                    ...
                                    <div class="user_greeting" style="margin-left:130%; margin-top:-100%;">Hello, <?php echo isset($_SESSION['username']) ? $_SESSION['username'] : 'Guest'; ?></div>
                                </div>
